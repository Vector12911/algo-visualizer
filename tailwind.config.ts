...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      animation: {
        // visitedAnimation:
        //   "visitedAnimation 2s ease-out 0 alternate 1 forwards running",
        // visitedAnimation: "visitedAnimation 2s ease-out forwards running",
        // visitedAnimation:
        //   "visitedAnimation 2s ease-out 2 alternate 1 forwards running",
        shortestPath:
          "shortestPath 1.5s ease-out 1 alternate 1 forwards running",
        wiggle: "visitedAnimation 1s ease-out",
      },
    },
  },
  plugins: [],
